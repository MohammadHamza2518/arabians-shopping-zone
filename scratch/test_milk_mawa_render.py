...
with sync_playwright() as p:
    ...
    page.screenshot(path="C:/Users/moham/.gemini/antigravity/brain/39f53ab6-18ce-4096-8de7-56ea97e98c3b/talbina_milk_mawa_verified_mobile.png")
    print("Saved talbina_milk_mawa_verified_mobile.png")
