...
with sync_playwright() as p:
    ...
    time.sleep(1)
    mob_page.screenshot(path="C:/Users/moham/.gemini/antigravity/brain/39f53ab6-18ce-4096-8de7-56ea97e98c3b/collections_mobile_perfect.png")
    print("Saved collections_mobile_perfect.png")
    browser.close()
