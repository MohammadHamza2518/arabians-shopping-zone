...
app.post('/api/products', requireAdminAuth, (req, res) => {
  ...
  const newProduct = {
    ...
    hasSizes: req.body.hasSizes !== undefined ? Boolean(req.body.hasSizes) : (Array.isArray(req.body.sizes) && req.body.sizes.length > 0),
...
app.put('/api/products/:id', requireAdminAuth, (req, res) => {
  ...
  store.products[idx] = {
    ...
    hasSizes: req.body.hasSizes !== undefined ? Boolean(req.body.hasSizes) : (store.products[idx].hasSizes ?? (Array.isArray(store.products[idx].sizes) && store.products[idx].sizes.length > 0)),
