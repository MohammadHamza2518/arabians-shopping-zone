...
export default function ReviewsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] py-5 sm:py-10 w-full max-w-full overflow-x-hidden">
      <SEO 
        title="Customer Reviews & Real Unboxing Videos (4.9★) | Arabians Shopping Zone"
        description="Explore 5,000+ verified customer reviews and video unboxings for authentic Talbina, Saudi thobes, Dehnul Oud, and Nikah certificates. 4.9/5 star satisfaction rating."
        url="https://arabiansshoppingzone.com/#/reviews"
      />
